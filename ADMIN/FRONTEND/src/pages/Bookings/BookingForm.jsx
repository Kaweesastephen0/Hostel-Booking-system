...
const BookingForm = ({ open, onClose, onSuccess }) => {
  ...
  // Fetch hostels when component opens
  React.useEffect(() => {
    if (open) {
      fetchHostels();
    }
        ...
        <DialogContent>
          ...
          <Box sx={{ mt: 2, maxHeight: '70vh', overflowY: 'auto', pr: 1 }}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid>
                <FormControl Width={20} margin="normal" required>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth margin="normal" required disabled={!newBooking.hostelName || loadingRooms}>
                    ...
                    {loadingRooms ? (
                      ...
                      rooms.map((room) => (
                        <MenuItem key={room._id} value={room._id}>
                          {room.roomNumber} - {room.roomType} (${room.bookingPrice || room.roomPrice})
                        </MenuItem>
                      ))
                    )}
                  </Select>
